...
function Prof1_taken_profRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof1_taken_profComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof1_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof1_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof2_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof2_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof3_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof3_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof4_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof4_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof5_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof5_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof6_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof6_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof7_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof7_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof8_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof8_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof9_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof9_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof10_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof10_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof11_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof11_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof12_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof12_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof13_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof13_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof14_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof14_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof15_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof15_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof16_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof16_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Prof17_enjoy_classRoutineBegin(snapshot) {
  return async function () {
    ...
    Prof17_enjoy_classComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
